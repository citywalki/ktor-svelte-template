...
sealed class SystemSetting {
  abstract val key: SystemSettingKey
}
...
@Serializable
data class GeneralSystemSetting(
  ...
  override val key: SystemSettingKey
    get() = SystemSettingKey.GENERAL
...
data class BasicSystemSetting(
  ...
  override val key: SystemSettingKey
    get() = SystemSettingKey.BASIC
}

@Serializable
data class StorageSystemSetting(val aaa: String? = null) : SystemSetting() {
  override val key: SystemSettingKey
    get() = SystemSettingKey.STORAGE
}

@Serializable
data class MemoRelatedSystemSetting(
  ...
  override val key: SystemSettingKey
    get() = SystemSettingKey.MEMO_RELATED
}

@Serializable
data class SystemProfile(
  // The name of instance owner.
  val owner: TableId? = null,
