...
@Serializable
data class GeneralGlobalSetting(
...
@Serializable
data class StorageGlobalSetting(val aaa: String? = null) : GlobalSetting() {
  override val key: GlobalSettingKey
    get() = GlobalSettingKey.STORAGE
}

@Serializable
data class MemoRelatedGlobalSetting(
